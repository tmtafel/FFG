// To parse this data:
//
//   import { Convert, StatData } from "./file";
//
//   const statData = Convert.toStatData(json);
...
export interface StatDataDebug {
    msg_id?: string;
...
export class Convert {
    public static toStatData(json: string): StatData {
        return JSON.parse(json);
    }

    public static statDataToJson(value: StatData): string {
